...
//          String password = request.getParameter("password");
          ...
          else
          {
              ...
              response.sendRedirect("http://localhost:8080/boutiqueStore/login-signup.jsf");
     ...
     {
         System.out.println("test " + KeepRecord.getToken());
         System.out.println("In Auth2");
          ...
          AuthenticationStatus status = validateToken(KeepRecord.getToken(), ctx);
